...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Mp3Extension",0f,3a,9c,fd),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("443",b3,a2,27,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Christopher Speciale",95,4b,30,9c));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Mp3Extension",0f,3a,9c,fd));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Mp3 Extension",8f,82,27,fb));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("Mp3Extension",0f,3a,9c,fd));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Mp3 Extension",8f,82,27,fb))
