...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Mp3Extension", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Mp3Extension", null, 800, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "443";
		app.meta["company"] = "Christopher Speciale";
		app.meta["file"] = "Mp3Extension";
		app.meta["name"] = "Mp3 Extension";
		app.meta["packageName"] = "Mp3Extension";
